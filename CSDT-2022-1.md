...
>- **Package Hierarchies Unbalanced  (Jerarquías de paquetes desequilibradas) :**
>
...
>- **Reinvent the Wheel :** 
>
>	Esto hace referencia a la obsolescencia del código que no permite el mantenimiento, actualización, e innovación del código y su desarrollo. 
>
>- **Overgeneralization :** 
>
>	En este caso no se podría reutilizar el código que se tiene, no existen maneras flexibles de acecuarlos para su mejora y no se puede utilizar y perfeccionar.
>	  
>	
